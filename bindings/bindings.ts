    ...
    LoadMusicStream: {
      ...
      result: {
        "struct": [
          ...
          "pointer", // stream.processor
          "u32", // stream.sampleRate
          "u32", // stream.sampleSize
          "u32", // stream.channels
          "u32", // frameCount (Note: this is frameCount, not part of AudioStream in the provided definition)
          "u8", // looping (bool)
